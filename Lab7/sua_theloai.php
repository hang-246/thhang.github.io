...
if(isset($_GET['id'])){
    ...
    $theloai_arr = $db_theloai->gettheloai($_GET['id']);
...
<tr>
<td>Tên thể loại: </td>
<td><input type="text" name="ten_theloai" value="<?php echo

$ten_theloai; ?>"></td>
</tr>
<tr>
<td>Thứ tự: </td>
<td><input type="text" name="thu_tu" value="<?php echo $thu_tu;
...
<tr>
<td colspan="2"><input type="submit" value="Cập nhật thể loại"
