	...
	<form action="bai6_2.php" method="POST">
		<table>
			...
			<tbody>
				...
				<tr>
					<td>Mảng: </td>
					<td><input type="text" name="mang_so"  value="<?php xuat_mang($mang_so); ?>"></td>
				</tr>
				<tr>
					<td>GTLN ( MAX ) trong mảng: </td>
					<td><input type="text" name="gtln"  value="<?php tim_max($mang_so); ?>"></td>
				</tr>
				<tr>
					<td>GTNN ( MIN ) trong mảng: </td>
					<td><input type="text" name="ttnn"  value="<?php tim_min($mang_so); ?>"></td>
				</tr>
				<tr>
					<td>Tổng mảng: </td>
					<td><input type="text" name="tong"  value="<?php tinh_tong($mang_so); ?>"></td>
				</tr>
			</tbody>
		</table>
	</form>
